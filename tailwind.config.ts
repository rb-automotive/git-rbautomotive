// tailwind.config.ts
// Ensure this file is named with the .ts extension

import type { Config } from 'tailwindcss';
// Import the PluginAPI type for the custom plugin function
// This path should be correct for standard Tailwind installations
...
const config: Config = {
  content: [
    ...
    './app/**/*.{js,ts,jsx,tsx,mdx}', // Include for App Router
  ],
  theme: {
    extend: {
      // Define custom theme extensions here
      fontFamily: {
        // Assumes --font-inter is set in layout.tsx
        sans: ['var(--font-inter)', 'ui-sans-serif', 'system-ui'],
        // Add heading font if you defined one (e.g., --font-heading)
        // heading: ['var(--font-heading)', 'ui-serif', 'Georgia'],
      },
      backgroundImage: {
        // Define custom gradients based on original CSS
        ...
        'section-bg': 'linear-gradient(135deg, #f9fafb 0%, #e5e7eb 100%)',
      ...
      boxShadow: {
        // Define custom shadows based on original CSS
      ...
      // Add any other custom colors, spacing, etc.
    },
  },
  plugins: [
